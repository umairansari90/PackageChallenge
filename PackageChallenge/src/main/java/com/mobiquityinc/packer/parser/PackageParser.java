...
/**
* This class provides facility to parse data in the form of
* 81 : (1,53.38,€45) (2,88.62,€98) and return Package info enclosed in optional
*
* @author UmairZ
* @since Apr 20, 2018
*
...
public class PackageParser {
	 ...
	 /**
	 * This function take input data in the form of 
	 * 81 : (1,53.38,€45) (2,88.62,€98) where 81 is the max weight
	 * and remaining part after column is the list of items. 
	 * 
	 * Note: If package max weight is greater then allowed max weight then
	 * this class returns Optional with null.
     * 
     * @param data
	...
	public Optional<PackageInfo> parsePackage(String data) {
		...
		/* Checks if weight provided in data is less than or equal to the provided maximum limit.
		 * If weight is valid, package info else null is returned enclosed in optional
		 */
